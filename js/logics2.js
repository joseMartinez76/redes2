    ...
    if (percentage >= 50) {
        ...
        certificationHTML = `
            <div style="background: #fff5f5; border: 1px solid #f5c6cb; padding: 25px; border-radius: 15px; margin-top: 30px; text-align: center; box-shadow: 0 4px 15px rgba(220, 53, 69, 0.1);">
                ...
                <p style="margin: 15px 0; color: #721c24; font-size: 1.1em;">No has alcanzado la puntuación mínima requerida. Revisa los puntos de mejora y vuelve a intentarlo.</p>
            </div>
        `;
    }
   ...
   const reportFooter = `
    <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #eee; text-align: center;">
        <div class="brand-header" style="justify-content: center;">
            <span class="brand-robot">🤖</span>
            <span class="brand-name">Jose Academy</span>
            <span class="brand-year">• 2026</span>
        </div>
        <div style="font-size: 0.8rem; color: #a0aec0; margin-top: 5px;">
            ID de Verificación: JA-${Math.floor(Math.random() * 90000) + 10000}
        </div>
    </div>
`;
